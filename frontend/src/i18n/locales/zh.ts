...
const zh: TranslationMessages = {
  ...
  common: {
    ...
    imageViewer: {
      helpExtended: '使用鼠标滚轮或 +/- 键缩放 • 拖动以移动 • Ctrl+S 保存 • ESC 关闭',
      zoomIn: '放大',
      zoomOut: '缩小',
    },
    language: {
  ...
  modal: {
    ...
    feed: {
      ...
      typeXPath: 'XPath',
      xpath: 'XPath 支持',
      xpathAutoFetchHint: '由于设置了链接 XPath 但未设置内容 XPath，将自动启用全文提取功能',
  ...
  setting: {
    ...
    ai: {
      ...
      clearAllChatsSuccess: '已成功清空 {count} 个对话',
      configValid: '配置有效',
    ...
    customization: {
      ...
      deleteCSS: '删除 CSS',
      script: '自定义脚本',
      scriptDesc: '使用自定义 JavaScript 脚本提取数据',
      scriptDoc: '查看文档',
    ...
    rsshub: {
      accessDenied:
        'RSSHub 访问被拒绝（403）。公共 rsshub.app 实例有使用限制。请部署您自己的 RSSHub 实例或在设置中配置 API 密钥',
      apiKey: 'API 密钥',
    ...
    update: {
      ...
      autoUpdateIntervalDesc: '自动检查更新的时间间隔（小时）',
